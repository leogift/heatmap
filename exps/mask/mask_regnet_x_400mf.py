...
class Exp(BaseExp):
    def __init__(self):
        ...
        self.data_dir = "coco128-seg"

        self.train_txt = "train.txt"
        self.val_txt = "val.txt"

        self.image_size = (512, 512)  # (height, width)
        self.category_list = ["person", "bicycle", "car", "motorcycle", "airplane", "bus", "train", "truck", "boat", "traffic light",
    ...
    def get_model(self):
        ...
        if "model" not in self.__dict__:
            ...
            head = HeatmapHead(
                    ...
                    num_heatmap=len(self.category_list)+1,
                    act=self.act, 
                    drop_rate=0.1,
                )
